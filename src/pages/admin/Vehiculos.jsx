...
useEffect(() => {
  console.log("Esta es una función que se ejecuta cada vez que cambia el valor nombreVehiculo");
  ...
  return (
    <form className="flex flex-col ">
      ...
      <button onClick={() => {console.log("El valor de la varible nombreVehiculo es ", nombreVehiculo)}} type="button" className="bg-indigo-500 text-white">Enviar datos</button>
    </form>
  )
};
